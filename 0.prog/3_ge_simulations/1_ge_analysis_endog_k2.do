...
local extx  : dir "`c(pwd)'"   files "*EXT2*.xls" 
...
drop _m
		...
		export excel using 	"`counterfactual'_EXT2_`X'_AM.xls", firstrow(variables) replace
	    save 				"`counterfactual'_EXT2_`X'_AM.dta", replace
