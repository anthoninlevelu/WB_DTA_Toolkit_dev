...
use "$DATA/DTA/uk_agree_to_be_fixed.dta", clear

rename id_agree raw_id_agree
...
/* 382 agreement in the cluster sample ( UK agreemts fixed with the same content as EU: )
...
tab provision if strpos( Area , "Antidumping") & strpos( Coding ,    "prov_42") 
 

replace   provision_value = "12" 	if provision_value=="15/10"       					 &   strpos( Area , "Antidumping") & (   strpos( Coding ,    "prov_42") ) 
 
 
 

/* minimum non 0 value */
replace   provision_value = "5" 	if provision_value=="as soon as possible"       	 &   strpos( Area , "Antidumping") & (  strpos( Coding ,    "prov_42") ) 

/* average non 0 value  (weighted by the frequency) */
replace   provision_value = "22" 	if provision_value=="within reaso0ble time frames" 	 &   strpos( Area , "Antidumping") & (  strpos( Coding ,    "prov_42") ) 
...
tab provision if strpos( Area , "Rules of Origin")  &    strpos(Coding, "roo_vcr_fnt")
...
* Rules of Origin - roo_drb: Does the agreement contain drawback rules? 
tab provision if strpos( Area , "Rules of Origin")   &    strpos(Coding, "roo_drb")

replace   provision_value = "2"  	if provision_value=="Zona Franca"  & strpos( Area , "Rules of Origin")  &    strpos(Coding, "roo_drb")
replace   provision_value = "2"  	if provision_value=="Zo0 Franca"   & strpos( Area , "Rules of Origin")  &    strpos(Coding, "roo_drb")


*  Rules of Origin - roo_dba: Does the agreement allow drawback ?  
tab provision if strpos( Area , "Rules of Origin")   &    strpos(Coding, "roo_dba")
...
/* 
Assuming al USD if not stated differently, convert in USD, (we use the EX from from the BCE): 
All time Average 1999-2024 
Average Pound   to Euro 1.28. 
Average Dollars to Euro 0.84
Average AUD     to Euro 0.63
Average RMB     to Euro 0.13

*/

tab provision if strpos( Area , "Rules of Origin")   &    strpos(Coding, "roo_cer_ex2")

replace   provision_value = "350" 	if strpos(provision_value,  "100 USD; 500 Pound")             & strpos( Area , "Rules of Origin")  & strpos(Coding, "roo_cer_ex2")
replace   provision_value = "650" 	if provision_value         =="1000AUD/ 6000 RMB"              & strpos( Area , "Rules of Origin")  & strpos(Coding, "roo_cer_ex2")
replace   provision_value = "420" 	if provision_value         =="500EUR"                         & strpos( Area , "Rules of Origin")  & strpos(Coding, "roo_cer_ex2")
...
replace   provision_value = "850" 	if provision_value         =="500 EUR (or 1500 in luggage)"   & strpos( Area , "Rules of Origin")  & strpos(Coding, "roo_cer_ex2")
...
replace   provision_value = "500" 	if strpos(provision_value,  "500 for small packages")      & strpos( Area , "Rules of Origin")  & strpos(Coding, "roo_cer_ex2")
replace   provision_value = "750" 	if strpos(provision_value,  "500 (EUR)/1200 (EUR)")        & strpos( Area , "Rules of Origin")  & strpos(Coding, "roo_cer_ex2")
replace   provision_value = "750" 	if strpos(provision_value,  "500 EUR; 1200 EUR")           & strpos( Area , "Rules of Origin")  & strpos(Coding, "roo_cer_ex2")
replace   provision_value = "750" 	if strpos(provision_value,  "EUR 500; 1,200")              & strpos( Area , "Rules of Origin")  & strpos(Coding, "roo_cer_ex2")

replace   provision_value = "550" 	if strpos(provision_value,  "1000 AUS Dollars")            & strpos( Area , "Rules of Origin")  & strpos(Coding, "roo_cer_ex2")
replace   provision_value = "1000" 	if strpos(provision_value,  "1200 Euro")                   & strpos( Area , "Rules of Origin")  & strpos(Coding, "roo_cer_ex2")
replace   provision_value = "1150" 	if strpos(provision_value,  "1000 Pound")                  & strpos( Area , "Rules of Origin")  & strpos(Coding, "roo_cer_ex2")




* min non 0 value (shallow agreement)
replace   provision_value = "200" 	if strpos(provision_value,  "low value importations"  )      & strpos( Area , "Rules of Origin")  & strpos(Coding, "roo_cer_ex2")

* min non 0 value (shallow agreement)
replace   provision_value = "200" 	if strpos(provision_value,  "low value shipments"      )     & strpos( Area , "Rules of Origin")  & strpos(Coding, "roo_cer_ex2")




* average non 0 value (weighted by frequency)
replace   provision_value = "1094" 	if strpos(provision_value,  "Parties may set their own limits"   )       & strpos( Area , "Rules of Origin")  & strpos(Coding, "roo_cer_ex2")

* average non 0 value (weighted by frequency)
replace   provision_value = "1094" 	if strpos(provision_value,  "according to domestic legistration"  )      & strpos( Area , "Rules of Origin")  & strpos(Coding, "roo_cer_ex2")

* average non 0 value (weighted by frequency)
replace   provision_value = "1094" 	if strpos(provision_value,  "in accordance with 0tio0l laws"     )       & strpos( Area , "Rules of Origin")  & strpos(Coding, "roo_cer_ex2")
...
tab provision if strpos( Area , "Rules of Origin")   &    strpos(Coding, "roo_cer_val")


replace   provision_value = "12" 	if strpos(provision_value,  "1 year")          & strpos( Area , "Rules of Origin") & strpos(Coding, "roo_cer_val")
replace   provision_value = "24" 	if strpos(provision_value,  "1 to 2")          & strpos( Area , "Rules of Origin") & strpos(Coding, "roo_cer_val")
...
* Assuming 1 means 1 year
replace   provision_value = "12" 	if strpos(provision_value,  "1")               & strpos( Area , "Rules of Origin") & strpos(Coding, "roo_cer_val")
replace   provision_value = "0" 	if provision_value == ""	   				   & strpos( Area , "Rules of Origin") & strpos(Coding, "roo_cer_val")
...
tab provision if strpos( Area , "Rules of Origin")    & strpos(Coding, "roo_cum_dm2")
...
* average non 0 value (weighted by frequency)
replace   provision_value = "10" 	if strpos(provision_value,  "1;7;10")        	 & strpos( Area , "Rules of Origin") & strpos(Coding, "roo_cum_dm2")
replace   provision_value = "0" 	if provision_value == ""	 					 & strpos( Area , "Rules of Origin") & strpos(Coding, "roo_cum_dm2")
...
tab provision if  strpos( Area , "Rules of Origin") & (   strpos( Coding , "roo_vcr_per") | strpos( Coding , "roo_vcr_per2")  )
...
* average non 0 value (weighted by frequency)
replace   provision_value = "33.2" 	if strpos(provision_value,  "7; 1")        				      		   & strpos( Area , "Rules of Origin") & (   strpos( Coding , "roo_vcr_per") | strpos( Coding , "roo_vcr_per2")  )
replace   provision_value = "33.2" 	if strpos(provision_value,  "See Annex 2 of Protocol")        		   & strpos( Area , "Rules of Origin") & (   strpos( Coding , "roo_vcr_per") | strpos( Coding , "roo_vcr_per2")  )
replace   provision_value = "33.2" 	if strpos(provision_value,  "See Annex 2 to Protocol on Rules")        & strpos( Area , "Rules of Origin") & (   strpos( Coding , "roo_vcr_per") | strpos( Coding , "roo_vcr_per2")  )
replace   provision_value = "33.2" 	if strpos(provision_value,  "See Annex 3-A")        				   & strpos( Area , "Rules of Origin") & (   strpos( Coding , "roo_vcr_per") | strpos( Coding , "roo_vcr_per2")  )
...
tab provision if  strpos( Area , "Rules of Origin") & (  strpos( Coding , "roo_cer_rec")  )
...
replace   provision_value = "0" 	if  provision_value == ""					  & strpos( Area , "Rules of Origin")  &  strpos( Coding , "roo_cer_rec")
...
replace   provision_value = "2"  	 	if provision_value=="D, F" 	 &   strpos( Area , "Services") & strpos(Coding, "roo_m3")	
replace   provision_value = "1"  	 	if provision_value=="F"  	 &   strpos( Area , "Services") & strpos(Coding, "roo_m3") 		
replace   provision_value = "1"  	 	if provision_value=="F, G"   &   strpos( Area , "Services") & strpos(Coding, "roo_m3")	
...
replace   provision_value = "3"  	 	if provision_value=="B, C"     &   strpos( Area , "Services") & strpos(Coding, "trans_comm_nat")
...
save "$TEMP/rta_data_for_cluster", replace
