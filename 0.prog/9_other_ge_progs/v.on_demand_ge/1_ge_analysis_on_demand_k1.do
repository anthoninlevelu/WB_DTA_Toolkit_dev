...
cap 	log close
capture log using "$PROG\00_log_files\ge_exd1_`=$iso'", text replace
...
local exdx  : dir "`c(pwd)'"   files "*EXD1*.xls" 
...
cap 	log close  
capture log using "$PROG\00_log_files\ge_extd1_`=$iso'", text replace
...
replace  rta_k1_cfl  		= 1  if ( iso_o == "`iso'"    			 & iso_d == "`counterfactual'" )   & (exporter!= importer)   & (rta == 0 | (rta == 1 & strpos(agreement, "GSTP")))
replace  rta_k1_cfl  		= 1  if ( iso_o == "`counterfactual'"    & iso_d == "`iso'"            )   & (exporter!= importer)   & (rta == 0 | (rta == 1 & strpos(agreement, "GSTP")))
...
replace  rta_k1_cfl  		= 1  if ( iso_o == "`iso'"    			 & eu_d  == 1        )   & (exporter!= importer)   & (rta == 0 | (rta == 1 & strpos(agreement, "GSTP")))
replace  rta_k1_cfl  		= 1  if ( eu_o  == 1                     & iso_d == "`iso'"  )   & (exporter!= importer)   & (rta == 0 | (rta == 1 & strpos(agreement, "GSTP")))
...
replace  rta_k1_cfl  	   = 1  if ( iso_o    == "`iso'"     & multi_d  == 1     )   & (exporter!= importer)   & (rta == 0 | (rta == 1 & strpos(agreement, "GSTP")))
replace  rta_k1_cfl  	   = 1  if ( multi_o  == 1           & iso_d == "`iso'"  )   & (exporter!= importer)   & (rta == 0 | (rta == 1 & strpos(agreement, "GSTP")))
...
replace  rta_k1_cfl  	   = 1  if ( iso_o    == "`iso'"     & rcep_d  == 1        )   & (exporter!= importer)  // & (rta == 0 | (rta == 1 & strpos(agreement, "GSTP")))
replace  rta_k1_cfl  	   = 1  if ( rcep_o   == 1           & iso_d   == "`iso'"  )   & (exporter!= importer)  // & (rta == 0 | (rta == 1 & strpos(agreement, "GSTP")))
...
drop _m
		...
		export excel using 	"`counterfactual'_EXD1_`X'_AM.xls", firstrow(variables) replace
	    save 				"`counterfactual'_EXD1_`X'_AM.dta", replace
